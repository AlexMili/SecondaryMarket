...
(0, 'yann', 'yann', 0, 0, 'yann.dalmat@live.fr');
INSERT INTO `ADMINISTRATEUR` VALUES(1, 'DALMAT', 'Yann', 0);
--- SOCIETE
INSERT INTO `SOCIETE` (`Id_Societe`, `adresse`, `codePostal`, `email`, `isApproved`, `nom`, `prixTitre`, `quantiteTitre`, `telephone`, `ville`) VALUES
(0, 'Test adresse société', 56565, 'testsociete@societe.com', 0, 'BNP Paribas Cardif', 54.89, 1000, 323232121, 'Rueil mal');
--- INVEST
INSERT INTO `UTILISATEUR` (`Id_Utilisateur`, `login`, `password`, `status`, `type`, `email`) VALUES
...
INSERT INTO `SOCIETE` (`Id_Societe`, `adresse`, `codePostal`, `email`, `isApproved`, `nom`, `prixTitre`, `quantiteTitre`, `telephone`, `ville`) VALUES(0, 'Test adresse société', 56565, 'testsociete@societe.com', 0, 'BNP Paribas Cardif', 54.89, 1000, 323232121, 'Rueil mal');
