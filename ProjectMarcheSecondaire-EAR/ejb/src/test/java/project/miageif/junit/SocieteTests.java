...
public class SocieteTests{
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class, "test.jar")
            .addClasses(Societe.class, SocieteService.class,
            		SocieteServiceImp.class, SocieteDAO.class, GenericDAO.class)
    ...
    public void getAllSocieties() {
    	List<?> listSociete = societeServ.getAllSocieteApprouvees();
	}
